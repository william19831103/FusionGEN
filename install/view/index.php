							...
							<form name="general-form" id="general-form" action="do_general.php" method="post" autocomplete="off">
								<div class="section clearfix">
									...
									<div>
										...
										<div class="form-group clearfix">
											...
											<div class="col-md-9">
												<select class="form-control" id="expansion" name="expansion">
													...
													<!--<option value="legion-ar">Legion Allied Races (7.3.5)</option>-->
										...
										<div class="form-group clearfix">
											<label class="col-md-3" for="cdn">Use content delivery network for Javascript libraries (do only disable it for LAN-only environments) (Recommended: Yes)</label>
											<div class="col-md-9">
												<select class="form-control" id="cdn" name="cdn">
